...
class CountriesAllData {
  ...
  CountriesAllData.fromJson(dynamic json) {
...
CountriesAllData copyWith({  num? updated,
  String? country,
  CountryInfo? countryInfo,
  num? cases,
  num? todayCases,
  ...
  num? recoveredPerOneMillion,
  num? criticalPerOneMillion,
}) => CountriesAllData(  updated: updated ?? _updated,
