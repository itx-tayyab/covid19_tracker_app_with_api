...
class CovidAllDataModal {
  ...
  CovidAllDataModal.fromJson(dynamic json) {
...
CovidAllDataModal copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => CovidAllDataModal(  updated: updated ?? _updated,
  cases: cases ?? _cases,
